<aside class="l-aside l-background__aside">
    <img class="l-background__aside-top c-img__aside_back" src="<?php echo esc_url(content_url('/uploads')); ?>/2024/04/background_tomoe.webp" alt=１つ目の背景">
